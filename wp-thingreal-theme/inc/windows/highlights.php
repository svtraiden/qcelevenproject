...
<style>
	...
	.input.red {
		background:url(<?php echo $_GET['url'];?>/../images/highlight-red.png) left top no-repeat;
	}
	.input.green {
		background:url(<?php echo $_GET['url'];?>/../images/highlight-green.png) left top no-repeat;
	}
	.input.yellow {
		background:url(<?php echo $_GET['url'];?>/../images/highlight-yellow.png) left top no-repeat;
	}
	.input.blue {
		background:url(<?php echo $_GET['url'];?>/../images/highlight-blue.png) left top no-repeat;
	}
</style>
<table><tr>
